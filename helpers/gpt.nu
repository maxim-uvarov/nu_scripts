# from https://github.com/glcraft/dotfiles/blob/main/.scripts/openai.nu
...
export def ask [
    ...
    let result = ($result.choices.0.message.content | str trim)

    {
        (now): {
        '1question': $input, 
        '2answer': $result, 
        '3system' : $messages.0.content
    }} | save -a '/Users/user/apps-files/github/gpt-answers/gpt-answers.yaml'
